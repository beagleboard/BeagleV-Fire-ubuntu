...
echo "- name: BeagleV-Fire Debian 13 v6.6.x" > ./images/${image_name}.img.xz.yml.txt
echo "  description: Debian 13 (Trixie) with no desktop environment for BeagleV-Fire based on Microchip Polarfire MPFS025T SoC FPGA running Microchip's linux 6.6" >> ./images/${image_name}.img.xz.yml.txt
